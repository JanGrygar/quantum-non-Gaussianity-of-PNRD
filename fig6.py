...
colors=["#10eda9","#3e76f2","#b122f2","#0f3085","#009568","#ed10c3","#00c828"]
...
for x in range(0,7):
    plt.errorbar(data[x][0],data[x][1],xerr=[[data[x][2]], [ data[x][3]]], yerr=[[data[x][4]], [data[x][5]]] ,fmt="o",color=colors[x],markersize=8,capsize=5,elinewidth=2,capthick=2)
